...
//WiFi
const char* SSID = "Poxnet-FILIPE_2G";                // SSID / nome da rede WiFi que deseja se conectar
const char* PASSWORD = "41793391882";   // Senha da rede WiFi que deseja se conectar
WiFiClient wifiClient;                        
 
//MQTT Server
const char* BROKER_MQTT = "mqtt3.thingspeak.com"; //URL do broker MQTT que se deseja utilizar
...
#define TOPIC "channels/2727582/publish/fields/field1"    //channels/<channelID>/publish/fields/field<fieldnumber> 
...
const long intervalo = 1800000;//1800000ms meia hora
